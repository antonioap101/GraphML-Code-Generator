...
from api.src.GraphMLGenerator.GraphML.graph.elements.data import Data
...
from api.src.GraphMLGenerator.GraphML.graph.elements.hyperedges.HyperEdge import HyperEdge
