...
from api.src.GraphMLGenerator.GraphML.graph.elements.external.Locator import Locator
from api.src.GraphMLGenerator.GraphML.graph.elements.port.Port import Port
...
class Node(GraphMLElement):
    ...
    def __init__(
        ...
        """
        from api.src.GraphMLGenerator.GraphML.graph.Graph import Graph  # Evitar dependencia circular
